...
const SAIYOUS = ['全て', '採用待ち', '採用', '非採用', '差戻し', '仮登録', '廃番'];
const PRODUCT_SAIYOUS = {
  0: '仮登録',
  1: '採用待ち',
  2: '差戻し',
  4: '非採用',
...
const IMAGE_EXTENSIONS = Object.freeze(['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'tif', 'eps']);
const VIDEO_EXTENSIONS = Object.freeze(['mp4', 'mov', 'wmv', 'avi', 'flv', 'ogv', 'webm']);
const AUDIO_EXTENSIONS = Object.freeze(['mp3', 'wav', 'wma', 'm4a', 'ogg', 'flac']);
const OFFICE_EXTENSIONS = Object.freeze(['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx']);
...
const ASSET_TABS = Object.freeze({
  IMAGE: '0',
  PDF: '1',
  VIDEO: '2',
  AUDIO: '3',
...
const FILTER_RELATIONS = Object.freeze({
  AND: '0',
  OR: '1'
});
...
const FILTER_CONDITION_CONTENT = [
  { cd: '0', name: '等しい' },
  { cd: '1', name: '等しくない' },
  { cd: '2', name: '設定されている' },
  { cd: '3', name: '設定されていない' },
...
const FILTER_CONDITION_NOMVER_CONTENT = [
  { cd: '0', name: '等しい' },
  { cd: '1', name: '等しくない' },
  { cd: '2', name: '設定されている' },
  { cd: '3', name: '設定されていない' },
...
const FILTER_CONDITION_LABEL_CONTENT = [
  { cd: '2', name: '設定されている' },
  { cd: '3', name: '設定されていない' }
];
